...
// Change the following line to choose which of buggy1-4 to test
import elevens.buggy1.*;

public class CardTester {

	/**
	 * Uncomment this main method to run Card tests, but make sure that the main
	 * method from DeckTester is commented out first.
	 */
	 /*
