...
public class MagicSquares{
	...
	public static Board staticBoard = new Board(3, 3);
	public static Board playBoard = new Board(3, 3);
		...
		while(!won){
			...
			if(currentClick.getRow() == 1 && currentClick.getCol() == 1){
				if(!playBoardState[currentClick.getRow()][currentClick.getCol()]){
					playBoard.putPeg("white", currentClick.getRow(), currentClick.getCol());
				...
				if(!playBoardState[currentClick.getRow()-1][currentClick.getCol()]){
					playBoard.putPeg("white", currentClick.getRow()-1, currentClick.getCol());
				...
				if(!playBoardState[currentClick.getRow()][currentClick.getCol()-1]){
					playBoard.putPeg("white", currentClick.getRow(), currentClick.getCol()-1);
