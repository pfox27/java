...
public static void main(String Args[]){
	...
	System.out.println("\nPlease enter the mass of the sample in grams: \n");
	double MassOfSample = scn.nextDouble();
	...
	for (int i = 1; i <= NumberOfElements; i++){
		...
		NumberOfMoles = MassOfSample/TotalMass;
		System.out.println("\nTotal molar mass is now \n" + TotalMass);
